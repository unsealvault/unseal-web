  ...
  return (
    <div className="space-y-1">
      <Textarea
        ...
        className="w-full min-h-[160px] bg-muted/20 border-border resize-none font-serif text-sm sm:text-base leading-relaxed p-3 focus-visible:ring-1 focus-visible:ring-[#991b1b]"
        required
      />
